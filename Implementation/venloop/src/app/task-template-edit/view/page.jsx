        ...
        <ProtectedRoute>
            <div className="font-sans md:bg-[#3CA9E2] min-h-screen">
                ...
                <div className="flex flex-col items-center py-6 px-4">
                    ...
                    <div
                        className="relative w-[360px] h-[640px] bg-gray-50 rounded-[40px] shadow-[0_4px_30px_rgba(255,255,255,0.4)] border border-white p-4 pr-1 overflow-y-auto">
                        <div className="relative">
                            <div
                                className="hidden md:block absolute top-4 left-1/2 -translate-x-1/2 w-24 h-7 bg-black rounded-full z-10 shadow-inner"></div>
                            <div
                                ...
                                <div className="flex space-x-2 w-full">
                                    {features.timer && (
                                        <div className="relative w-1/2">
                                            ...
                                            <div
                                                className="bg-white border rounded p-2 shadow flex justify-center items-center min-h-[120px]">
                                                <TaskFeatureTimer
                                    ...
                                    {features.choice && (
                                        <div className="relative w-full">
                                            ...
                                            <div
                                                className="bg-white border rounded p-2 shadow max-h-[160px] overflow-y-auto">
